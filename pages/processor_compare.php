        ...
        <!-- <form action="" method="POST" enctype="multipart/form-data"> -->
          ...
          if(isset($_POST["fetch"])){ 
            ...
            // echo "../images/laptops/$row1[1]";
              ...
              echo "<div class=' row container-fluid  ' style='width:90%; margin-top:8%;'>
                            <div class='container  col-auto p-3' style='width:500px; height:350px; position:absolute; margin-left:100px; margin-top:6%;' ><img src='../images/processors/$row1[1]' alt='Image' style='width:100%; height:100%;'></div>
              ...
              <div class=' row container-fluid  ' style='width:90%; margin-top:8%;'>
                            <div class='container  col-auto p-3' style='width:500px; height:350px; position:absolute; margin-left:100px; margin-top:6%;' ><img src='../images/processors/$row2[1]' alt='Image' style='width:100%; height:100%;'></div>
