        ...
        <!-- <form action="" method="POST" enctype="multipart/form-data"> -->
          ...
          if(isset($_POST["fetch"])){ 
            ...
            // echo "../images/laptops/$row1[1]";
              ...
              <div class='container col p-2' style='margin-left:10%;'><img src='../images/mobiles/$row1[mobile_image]' alt='Image' style='width:500px; margin-top:30%;'></div>
            ...
            <br>
              ...
              <div class='container col p-2' style='margin-left:10%;'><img src='../images/mobiles/$row2[mobile_image]' alt='Image' style='width:500px; margin-top:30%;'></div>
