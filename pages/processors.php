    ...
    if(isset($_POST['fetch'])){
      ...
      $query="SELECT * FROM processor_image WHERE processor_name='$_POST[option]'"; 
            ...
            // echo"../images/processors/$row[6]";
              ...
              <div class='container col p-2' style='margin-left:10%;'><img src='../images/processors/$row[processor_image]' alt='Image' style='width:500px; margin-top:30%;'></div>
            ...
            <br>
              <div class='container shadow p-5' style='width:150%; margin-left:100px; position:relative; margin-top:10%' >
                        ...
                        >&#10003;</span> &nbsp;&nbsp;Processor :</strong></i> $row[1] </p>
                        <p class='h4' style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp;Rear Camera :</strong></i> $row[5] </p>
                        <p class='h4'style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp;Front Camera : </strong></i>$row[4] </p>
                        <p class='h4' style='margin-left:0%;'><i><strong><span>&#10003;</span> &nbsp;&nbsp;Display :</strong></i> $row[3] </p>
              </div>
              </div>
              </div>";
